...
<body>
    <header class="header">
        <div class="header__barra contenedor">
            ...
            <nav class="nav">                
                <?php if ($tipo=='1'):?>                    
                    <!-- <a href="/cita" class="nav__a"><i class="fa-solid fa-calendar-check"></i>Tramitar cita</a> -->
                    <!-- <a href="/mis_citas" class="nav__a"><i class="fa-solid fa-calendar-days"></i>Mis citas</a>                     -->
                    <!-- <a href="/mis_citas" class="nav__a"><i class="fa-solid fa-calendar-days"></i>Servicios</a>
                    <a href="/mis_citas" class="nav__a"><i class="fa-solid fa-calendar-days"></i>Galeria</a>
                    <a href="/mis_citas" class="nav__a"><i class="fa-solid fa-calendar-days"></i>Sobre nosotros</a> -->
                    <?php if(!$autenticar):?>
